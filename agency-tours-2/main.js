...
console.log(tot_aloj_t);
console.log(tot_com_t);
console.log(val_tiq_t);
    



    document.getElementById("valor-t").value = val_t ;
    document.getElementById("descuento").value = des_t;
    document.getElementById("valor-n-p").value = val_t_n;
